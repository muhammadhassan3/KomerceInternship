...
<div class="background-society">
    <?php $image = get_template_directory_uri() . "/Images/FotoSociety.png"; ?>
...
<div class="btn-society">
    <button class="load-more-button">Tampilkan lebih banyak</button>
    <button class="load-less-button" style="display: none;">Tampilkan lebih sedikit</button>
</div>
